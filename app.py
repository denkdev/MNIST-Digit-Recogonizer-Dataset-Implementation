...
def train(A_0, W_1, B_1, W_2, B_2, Y, learning_rate):
    ...
    print(f'The training Accuracy of the Network is : {accuracy(A_2, Y):.8f}')
    return W_1,B_1,W_2,B_2
...
# ... [Insert your original neural network code here] ...

# Modified training loop with output capture
def run_training():
    # Capture print output
    old_stdout = sys.stdout
    sys.stdout = buffer = io.StringIO()
    
    # Reduced epochs for web demonstration
    num_epochs = 5  # Reduced from 500 for web usability
    for epoch in range(num_epochs):
        W_1, B_1, W_2, B_2 = train(X, W_1, B_1, W_2, B_2, Y, learning_rate)
